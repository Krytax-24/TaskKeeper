...
function showList(input) {
  ...
  list.innerHTML += `
    <li class="list-item" id="list${i}" onclick="strikeAndFadeOut(${i})">
...
function strikeAndFadeOut(id) {
  let listText = document.getElementById(`list-text${id}`);
  listText.classList.add('strikethrough');
  listText.classList.add('fade-out');
}
